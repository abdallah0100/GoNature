...
public class UserRequestController {
	...
	public static void insertInstructor(String instructor_id,String instructor_email,String instructor_tel) {
		ClientController.getController().accept(new Message(RequestType.INSERT_INSTRUCTOR,
												new Visitor(instructor_id,instructor_email,instructor_tel)));
	}
