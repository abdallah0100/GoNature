...
/**
 * Controller class for managing the Cancellations Report Frame.
 */
public class CancellationsReportFrameController implements Initializable {
    ...
    /**
     * Handles the action when the user clicks the button to show the graph window.
     * 
    ...
    /**
     * Sets the array list for the left table.
     * 
     * @param arrayListLeft the array list for the left table
     */
    ...
    /**
     * Sets the array list for the right table.
     * 
     * @param arrayListRight the array list for the right table
     */
